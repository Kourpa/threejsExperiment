...
ObjectControls = function(camera, domElement, objectToMove) {
    mesh = objectToMove;
    ...
    this.setScaleSpeed = function(newScaleSpeed){
    ...
    function wheel(e) {
      ...
      if (delta > 0 && mesh.scale.x > minScale) {
        zoomIn();
      } else if (delta < 0 && mesh.scale.x < maxScale) {
        zoomOut();
      }
    }
